                ...
                .enqueue(object : Callback<ProfileResponse> {
                    override fun onResponse(
                        ...
                        if (response.isSuccessful && response.body() != null) {
                            ...
                            val call = RetrofitClient.instance.getUserAnnouncements("Bearer $token")
                                ...
                                override fun onResponse(
                                    ...
                                    if (response.isSuccessful && response.body() != null) {
                                        ...
                                        if (announcementsList.isNotEmpty()) {
                                            ...
                                            textview_announcement_description.setText(
                                            ...
                                            Log.d(
                                                "LATEST_ANNOUNCEMENT",
                                                "Title: ${latestAnnouncement.title}, Description: ${latestAnnouncement.description}"
                                            )
                                        } else {
                                            Log.d(
                                                "LATEST_ANNOUNCEMENT",
