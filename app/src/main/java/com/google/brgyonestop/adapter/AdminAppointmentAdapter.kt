...
class AdminAppointmentAdapter (
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View = convertView ?: LayoutInflater.from(context).inflate(R.layout.item_allappointment, parent, false)
        ...
        val allappointment_name =view.findViewById<TextView>(R.id.allappointment_name)
        ...
        allappointment_name.setText(
            "${appointment.user.firstName ?: ""} ${appointment.user.middleName ?: ""} ${appointment.user.lastName ?: ""} ${appointment.user.suffix ?: ""}".trim()
        )
